...
pub const THEMES: phf::Map<&'static str, fn() -> Theme> = ::phf::Map {
    ...
    entries: &[
        ...
        ("alabaster", alabaster),
        ("nord", nord),
        ("rustdoc_ayu", rustdoc_ayu),
        ("lucius_light", lucius_light),
        ("github_dark", github_dark),
        ("catppuccin_latte", catppuccin_latte),
        ("rustdoc_light", rustdoc_light),
        ("evergarden_fall", evergarden_fall),
        ("solarized_light", solarized_light),
        ("ef_melissa_dark", ef_melissa_dark),
